...
Module("Cactus.Web", function (m) {
  ...
  function ListTemplate(arrayController, templatePrototypes, rootElement) {
    ...
    setFirstClassName : function (className) {
      var hasElem = this.hasDataSource() && this._getDataSource().size() !== 0;
      if (hasElem) {
    ...
    setLastClassName : function (className) {
      var size;
      var hasElem = this.hasDataSource() && (size = this._getDataSource().size()) !== 0;
      if (hasElem) {
        ClassNames.del(this.getListItem(size - 1), this.lastClassName);
      }
    ...
    setSingleClassName : function (className) {
      var hasElem = this.hasDataSource() && this._getDataSource().size() === 1;
      if (hasElem) {
    ...
    _setClassNames : function () {
      var size = this._getDataSource().size();
      if (size) {
        ClassNames.add(this.getListItem(0), this.firstClassName);
        ClassNames.add(this.getListItem(size - 1), this.lastClassName);
      }
     ...
     * @param natural index
     */
    onObjectAddedTriggered : function (arrayController, object, index) {
