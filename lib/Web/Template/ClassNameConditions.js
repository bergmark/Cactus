    ...
    methods : {
      ...
      set : function (keyPath) {
        ...
        for (i = 0; i < conditions.length; i++) {
          ...
          ClassNames.toggleCond(this.rootElement, condition.className,
            this.getDataSource().getValue(keyPath) !== condition.negate);
        }
      },
      /**
      ...
      /**
       * Given a new root element the ClassNameConditions is cloned.
       * Data source bindings are lost so they have to be reset using bindTo.
       *
       * @param HTMLElement rootElement
