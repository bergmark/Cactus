...
Module("Cactus.Web", function (m) {
  ...
  function Template(rootElement) {
    ...
    refresh : function () {
      ...
      this.classNameConditions._attach();
    },
    /**
    ...
    _setValue : function (keyPath, value) {
      this.classNameConditions._set(keyPath);
    ...
    _clone : function () {
      ...
      for (var keyPath in this.classNameConditions.conditions) {
          var conditions = this.classNameConditions.conditions[keyPath];
          for (i = 0; i < conditions.length; i++) {
            var v = conditions[i];
            newTemplate.classNameConditions.add(keyPath, v.className, v.negate);
