...
Module("Cactus.Web", function (m) {
  ...
  function Template(rootElement) {
    ...
    this.widgets = [];
    this.keyPaths = [];
    this.classNameConditions = new Template.ClassNameConditions(this);
    this.skipKeyPaths = [];
    this.modes = {};
  } Template.prototype = {
    /**
    ...
    refresh : function () {
      ...
      this.classNameConditions._attachClassNameConditions();
    },
    /**
    ...
    _setValue : function (keyPath, value) {
      this.classNameConditions._setClassNameCondition(keyPath);
    ...
    _clone : function () {
      ...
      for (var keyPath in this.classNameConditions.classNameConditions) {
          var conditions = this.classNameConditions.classNameConditions[keyPath];
          for (i = 0; i < conditions.length; i++) {
            var v = conditions[i];
            newTemplate.classNameConditions.addClassNameCondition(keyPath,
                                              v.className,
                                              v.negate);
  ...
  Template.create = function (source, settings) {
    ...
    for (i = 0; i < v.length; i++) {
      template.classNameConditions.addClassNameCondition(v[i].keyPath, v[i].className, v[i].negate);
    }
    v = settings.widgets;
    for (i = 0; i < v.length; i++) {
