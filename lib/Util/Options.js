    ...
    methods : {
      BUILD : function (definition, throwErrors) {
        ...
        if ("map" in definition) {
          this.definition.map = definition.map;
        }
      },
      parse : function (options, throwErrors) {
        ...
        if (this.definition.type instanceof Type && options !== null && options !== undefined) {
        ...
        } else if (this.definition.map && options !== null && options !== undefined) {
          // Maps.
          ...
          throwError();
          options = m;
        } else if (this.definition.type instanceof Object && options !== null) {
          // Hashes.
