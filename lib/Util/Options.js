...
Module("Cactus.Util", function (m) {
  ...
  var T_Union = Class({
    ...
    methods : {
      ...
      check : function (value, em) {
        if (!collection.hasValue(this.types, Options.typeof(value))) {
      ...
      check : function (value, em) {
        if (!(value instanceof this._constructor)) {
          em.add("", 'Expected an instance of "%s", but got value <%s> (type "%s")'
                 .format(this._getName(), value, Options.typeof(value)));
        }
        return value;
      },
      _getName : function () {
  ...
  var typeFail = function (type, value) {
    return "Expected " + JSON.stringify(Options.gettype(type)) +
      ", but got " + JSON.stringify(value) + " (type " + JSON.stringify(Options.typeof(value)) + ")";
  };
