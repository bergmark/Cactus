...
Module("Cactus.Data", function (m) {
  ...
  var ArrayControllerDecorator = Class("ArrayControllerDecorator", {
    isa : ArrayController,
    has : {
      /**
    ...
    methods : {
      ...
      _addSubscriptions : function () {
        this.component.subscribe("Added", this);
        this.component.subscribe("Rearranged", this);
        this.component.subscribe("Removed", this);
        this.component.subscribe("Swapped", this);
        this.component.subscribe("Replaced", this);
        this.component.subscribe("Filled", this);
        this.component.subscribe("Emptied", this);
      },
      /**
       ...
       * It's triggered by onRearranged.
       */
      ...
      /**
       * Triggered when the component sends out onAdded. The default
      ...
      onAddedTriggered : function (component, object, index) {
        ...
        this.onAdded(this.objects.length - 1);
      },
      /**
       * Triggered when the component sends out onRemoved. The default
      ...
      /**
       * Triggered when the component sends aut onRearranged. This method
       * should probably not be overridden by subclasses.
       *
       * @param ArrayController component
       */
      onRearrangedTriggered : function (component) {
        this._setObjects();
        this.onRearranged();
      },
      /**
      ...
      /**
       * Default is to skip handling this event since onAdded is also called
       * when this happens. Override if you want special behaviour when this occurs.
       */
      onFilledTriggered : function () {
        this.onFilled();
      },
      /**
       * Default is to skip handling this event since onRemoved is also called
       * when this happens. Override if you want special behaviour when this occurs.
       */
      onEmptiedTriggered : function () {
        this.onEmptied();
      }
    }
  });
