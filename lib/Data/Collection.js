  ...
  Joose.Class("Collection", {
    methods : {
      ...
      sliceWithRange : function (collection, range) {
        return this.slice(collection, range.getStart(), range.getEnd() + 1);
      },
      /**
      ...
      notAny : function (collection, pred) {
        return !this.some(collection, pred);
      },
      /**
      ...
      notEvery : function (collection, pred) {
          return !this.every(collection, pred);
      },
      /**
