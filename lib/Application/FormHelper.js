...
Module("Cactus.Application", function (m) {
  ...
  Class("FormHelper", {
    ...
    methods : {
       ...
       * @return Renderer
       */
      newRenderer : function (data, action) {
        return new m.Renderer(this, data || this.newData(), action);
      }
    },
    continued : {
      methods : {
        ...
        outTransformCont : function (fieldName, value) {
          if (!(fieldName in this._definition)) {
            ...
            this._definition[fieldName].outTransformerCont(this.CONT.getCONTINUE(), value);
          }
        }
      }
    }
