 ...
 * @file
 *
 * Service is meant to be used to specify the communication between
 ...
 * file). The client calls Service:newRenderer(dto) to make a
 * renderer for the specific Service. The client then has to call
