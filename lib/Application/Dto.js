...
Module("Cactus.Application", function (m) {
  ...
  Class("Dto", {
    ...
    methods : {
       ...
       */
      BUILD : function (service, defaults) {
        return {
          _service : service,
          _defaults : defaults || {}
        };
      ...
      getWithDefault : function (fieldName, defaultValue) {
        ...
        return this._service.inTransform(fieldName, v);
      },
      /**
       ...
       */
      isValid : function () {
        var o = this._service._fieldOptions;
       ...
       */
      get : function () {
        this._service.parse(this._values);
        return this._values;
      }
    },
    continued : {
      methods : {
        ...
        reversePopulate : function (values, helpers) {
          ...
          o.map(values, function (name, value) {
            cont.and(function () {
              me._service.outTransformCont(name, value, helpers).thenRun(function (transformedValue) {
